...
"                                      stop: 0 #dadbde, stop: 1 #f6f7fa);}")
    ...
    def retranslateUi(self, Student_Data):
        ...
        self.division.setItemText(1, _translate("Student_Data", "A"))
        self.division.setItemText(2, _translate("Student_Data", "B"))
        self.division.setItemText(3, _translate("Student_Data", "C"))
        self.division.setItemText(4, _translate("Student_Data", "D"))
        self.division.setItemText(5, _translate("Student_Data", "E"))
        self.division.setItemText(6, _translate("Student_Data", "F"))
        self.division.setItemText(7, _translate("Student_Data", "G"))
        self.division.setItemText(8, _translate("Student_Data", "H"))
        self.grade.setItemText(1, _translate("Student_Data", "KG-1"))
        self.grade.setItemText(2, _translate("Student_Data", "KG-2"))
        self.grade.setItemText(3, _translate("Student_Data", "1"))
        self.grade.setItemText(4, _translate("Student_Data", "2"))
        self.grade.setItemText(5, _translate("Student_Data", "3"))
        self.grade.setItemText(6, _translate("Student_Data", "4"))
        self.grade.setItemText(7, _translate("Student_Data", "5"))
        self.grade.setItemText(8, _translate("Student_Data", "6"))
        self.grade.setItemText(9, _translate("Student_Data", "7"))
        self.grade.setItemText(10, _translate("Student_Data", "8"))
        self.grade.setItemText(11, _translate("Student_Data", "9"))
        self.grade.setItemText(12, _translate("Student_Data", "10"))
        self.grade.setItemText(13, _translate("Student_Data", "11"))
        self.grade.setItemText(14, _translate("Student_Data", "12"))
