...
class Ui_Fees_deposit(object):
    def setupUi(self, Fees_deposit):
        ...
        self.label.setGeometry(QtCore.QRect(140, 30, 401, 51))
        font = QtGui.QFont()
        ...
        self.txtcheckname.setGeometry(QtCore.QRect(170, 20, 111, 21))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.label_2.setGeometry(QtCore.QRect(130, 20, 59, 21))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
